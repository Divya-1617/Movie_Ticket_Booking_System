 ...
 <i class="fa fa-comments-o" style="font-size:36px"></i>
  ...
  <a href="admin_ticket_report1.php" class="w3-bar-item w3-button w3-padding-large w3-hover-black">
	...
	<div class="main">
		...
		<div class="stats">
            <div class="stat-box">
                <h2><a href="admin_ipayment_report.php"  style="text-decoration:none; color:#FFFFFF"> Payment Report Through Home Page </a> </h2>
                
            </div>
			
			<div class="stat-box">
                <h2><a href="admin_cpayment_report.php" style="text-decoration:none; color:#FFFFFF;"> Payment Report Through Category Page </a> </h2>
            </div>
            <div class="stat-box">
                <h2><a href="admin_lpayment_report.php" style="text-decoration:none; color:#FFFFFF"> Payment Report Through Library Page  </a> </h2>
            </div>
