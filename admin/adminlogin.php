...
<body>
<A href="../user/index.php"> <i class="fa-solid fa-arrow-left" style="color: #ffffff; height: 80px; width: 80px; margin:15px 15px 15px 15px"></i></A>
<div class="background-wrap" s>


  <div class="background"></div>
</div>

<form id="accesspanel" action="adminlogin.php" method="post">
  ...
  <div class="inset">
    ...
    <p>
      <input type="password" name="paswsord" id="password" placeholder="Password">
    </p>
...
include('dbcon.php');
 ...
 {  
  $email = $_POST['email'];	
  $paswsord = $_POST['paswsord']; 
 
  $n=0;
  $result=mysqli_query($con,"select * from admin") or die("record not find");
  while( $row=mysqli_fetch_array($result,MYSQLI_BOTH))
  {
    if($row['email']==$email && $row['paswsord']==$paswsord) 
    {
