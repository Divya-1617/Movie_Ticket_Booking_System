 ...
 <i class="fa fa-comments-o" style="font-size:36px"></i>
  ...
  <a href="admin_ticket_report1.php" class="w3-bar-item w3-button w3-padding-large w3-hover-black">
	...
	<div class="main">
		...
		<div class="stats">
            <div class="stat-box">
                <h2><a  style="text-decoration:none; color:#FFFFFF">Manage Payment Through Home Page </a> </h2>
                
            </div>
			
			<div class="stat-box">
                <h2><a style="text-decoration:none; color:#FFFFFF;">Manage Payment Through Category Page </a> </h2>
            </div>
            <div class="stat-box">
                <h2><a style="text-decoration:none; color:#FFFFFF">Manage Payment Through Library Page  </a> </h2>
            </div>
