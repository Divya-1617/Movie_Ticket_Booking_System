...
<nav class="w3-sidebar w3-bar-block w3-small w3-hide-small w3-center">
 ...
 <i class="fa fa-comments-o" style="font-size:36px"></i>
  ...
  <a href="admin_ticket_report.php" class="w3-bar-item w3-button w3-padding-large w3-hover-black">
    <i class="fa fa-eye w3-xxlarge"></i>
    <p>TICKET-REPORT</p>
  </a>
  
     <a href="admin_payment_report.php" class="w3-bar-item w3-button w3-padding-large w3-hover-black">
  ...
  <header class="w3-container w3-padding-32 w3-center w3-black" id="home">
    <h1 class="w3-jumbo"><span class="w3-hide-small">Ticket &nbsp;</span>Report</h1>
	    ...
	    <table width='50%' border="1" cellspacing="0">
	      <tr bgcolor="#333333" align="center">
	        <td height="43"><span class="style3">Sr. No.</span></td>
			 <td><div align="center" class="style3">Name of customer</div></td>
<td><div align="center" class="style3">No of tickets </div></td>
<td><div align="center" class="style3">Seating type </div></td>
<td><div align="center" class="style3">Location </div></td>
<td><div align="center" class="style3">No of popcorn </div></td>
<td><div align="center" class="style3">No of sodas </div></td>
