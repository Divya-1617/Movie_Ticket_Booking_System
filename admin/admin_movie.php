...
$sql = "SELECT * FROM `movie` ORDER BY `rid` DESC";
 $query= $con->query($sql);
?>
...
<nav class="w3-sidebar w3-bar-block w3-small w3-hide-small w3-center">
 ...
 <i class="fa fa-comments-o" style="font-size:36px"></i>
  ...
  <header class="w3-container w3-padding-32 w3-center w3-black" id="home">
    <h1 class="w3-jumbo"><span class="w3-hide-small">Manage  &nbsp;</span>Movie</h1>
	...
	<div id="rpt">
	  <div align="center">
		...
		while ($res = $query->fetch_assoc()) {
			...
			echo "<td>".$res['type']."</td>";
			echo "<td><a href=\"admin_movie_add.php?id=$res[rid]\">Add</a>
			<a href=\"admin_movie_edit.php?id=$res[rid]\">Edit</a>
			<a href=\"admin_movie_delete.php?id=$res[rid]\" onClick=\"return confirm('Are you sure you want to delete?')\">Delete</a></td>";
			;
