...
<nav class="w3-sidebar w3-bar-block w3-small w3-hide-small w3-center">
 ...
 <i class="fa fa-comments-o" style="font-size:36px"></i>
  ...
  <header class="w3-container w3-padding-32 w3-center w3-black" id="home">
    <h1 class="w3-jumbo"><span class="w3-hide-small">Manage  &nbsp;</span>Feedback</h1>
	...
	<div id="rpt">
	  <div align="center">
	    ...
	    <p>&nbsp;</p>
	    <p>&nbsp;</p>
			<p align="center"><span class="style1"><span class="style2"><a href="admin_feedback_add.php">Add New Feedback</a> 
		...
		while ($res = $query->fetch_assoc()) {
			...
			echo "<td><a href=\"admin_feedback_edit.php?id=$res[rid]\">Edit</a>
			<a href=\"admin_feedback_delete.php?id=$res[rid]\" onClick=\"return confirm('Are you sure you want to delete?')\">Delete</a></td>";
			;
