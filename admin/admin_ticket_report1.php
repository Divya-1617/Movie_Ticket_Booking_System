 ...
 <i class="fa fa-comments-o" style="font-size:36px"></i>
  ...
  <a href="admin_ticket_report1.php" class="w3-bar-item w3-button w3-padding-large w3-hover-black">
	...
	<div class="main">
		...
		<div class="stats">
            <div class="stat-box">
                <h2><a href="admin_hticket_report.php" style="text-decoration:none; color:#FFFFFF">Ticket Report Through Home Page </a> </h2>
                
            </div>
			
			<div class="stat-box">
                <h2><a href="admin_cticket_report.php" style="text-decoration:none; color:#FFFFFF;"> Ticket Report Through Category Page </a> </h2>
            </div>
            <div class="stat-box">
                <h2><a href="admin_lticket_report.php" style="text-decoration:none; color:#FFFFFF"> Ticket Report Through Library Page  </a> </h2>
            </div>
