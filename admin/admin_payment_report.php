...
<nav class="w3-sidebar w3-bar-block w3-small w3-hide-small w3-center">
  ...
  <img class="logo" src="https://cdn-icons-png.flaticon.com/512/306/306425.png" style="width:90%"> <h3>Admin</h3><BR>
 ...
 <i class="fa fa-comments-o" style="font-size:36px"></i>
  ...
  <header class="w3-container w3-padding-32 w3-center w3-black" id="home">
    <h1 class="w3-jumbo"><span class="w3-hide-small">Payment &nbsp;</span>Report</h1>
	    ...
	    <table width='50%' border="1" cellspacing="0">
	      <tr bgcolor="#333333" align="center">
	        <td height="43"><span class="style3">Sr. No.</span></td>
			  ...
			  <td><span class="style3">Expity Year</span></td>
			  <td><span class="style3">CVV</span></td>
		</tr>
	      <?php
