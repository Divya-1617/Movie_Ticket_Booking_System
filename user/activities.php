...
<div class="s-right">
  ...
  <a href="about.php">About Us</a>
    ...
    <h1 style="margin-top: 10px;">Activites In Ahmednagar</h1>
        

    <div class="container">
        <div class="card">
          <img src="../img/a1" alt="" width="600" height="400">
          <img src="../img/a2" alt="" width="600" height="400">
          <img src="../img/p3" alt="" width="600" height="400">
          <img src="../img/a4" alt="" width="600" height="400">
          <img src="../img/a5" alt="" width="600" height="400">
