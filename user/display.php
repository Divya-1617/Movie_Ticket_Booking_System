...
$sql = "SELECT * FROM seat ORDER BY rid DESC LIMIT 1;";
 $query= $con->query($sql)
?>
...
<section class="image-text-section">
	...
	<img src="../photos/Fukrey-3-poster.jpeg" width="50%">
    </div>
    ...
    <div class="text-container" >
       ...
       <h1 style="color: white;">Movie Ticket and Food Counter</h1>
        <div class="form" style="background-color: rgb(240, 240, 240);">
			 ...
			 <form id="booking-form" method="post" action="display.php">
	  ...
	  <table width='80%' border="1" cellspacing="0" style="text-align:center; margin-left:10px;">
	    <tr>
					      <td height="47"><div align="center" class="style3 style5" >Customer ID</div></td>
	    ...
	    <label for="movie">Selected Movie:</label>
            <select id="movie" name="movie">
                <option value="150">Fukrey 3</option>
...
function calculateTotal() {
    ...
    const ticketPrice = 400; // Price per movie ticket
...
$qry="INSERT INTO `booking`( `rid`,`no`,`popcorn`,`soda`,`seating`,`location`,`date`,`time`,`total`) VALUES(NULL,'$no','$popcorn','$soda','$seating','$location','$date','$time','$total')";
