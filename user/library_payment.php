...
<div id="form-container">
  ...
  <div id="card-front">
    ...
    <div id="image-container">
      <table width='70%' border="0" cellspacing="0" style="text-align:left; margin-left:10px;">
	    <tr>
...
<form method="post" action="library_payment.php">
    <label for="card-number">
        Card Number
      </label>
    <input type="text" name="cno" id="card-number" placeholder="1234 5678 9101 1112" length="16" required>
    <div id="cardholder-container">
      <label for="card-holder">Card Holder
      </label>
      <input type="text" name="name" id="card-holder" placeholder="e.g. John Doe" required />
    </div>
    ...
    <div id="exp-container">
      ...
      <input id="card-month" name="expiry" type="text" placeholder="MM" length="2" required>
      <input id="card-year" name="expiry2" type="text" placeholder="YY" length="2" required>
    </div>
        <div id="cvc-container">
      <label for="card-cvc"> CVC/CVV</label>
      <input id="card-cvc" name="cvv" placeholder="XXX-X" type="text" min-length="3" max-length="4" required>
  ...
  <input type="text" id="card-token" />
	<input type="submit" value="submit" name="submit" id="card-btn">
...
$qry="INSERT INTO `lpayment`( `rid`,`cno`,`name`,`expiry`,`expiry2`,`cvv`) VALUES(NULL,'$cno','$name','$expiry','$expiry2','$cvv')";
$run=mysqli_query($con,$qry);

if($run==true)
{
	echo '<script>alert("Pyment paid Successfully...")</script>';
   echo '<script>window.location.href = "library_display_bill.php";</script>';
}
else
{
