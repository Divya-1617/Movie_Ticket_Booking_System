...
<form method="post" action="index_payment.php">
    ...
    <div id="exp-container">
      ...
      <input id="card-cvc" name="cvv" placeholder="XXX-X" type="text" min-length="3" max-length="4">
...
$qry="INSERT INTO `ipayment`( `rid`,`cno`,`name`,`expiry`,`expiry2`,`cvv`) VALUES(NULL,'$cno','$name','$expiry','$expiry2','$cvv')";
$run=mysqli_query($con,$qry);

if($run==true)
{
	echo '<script>alert("Pyment paid Successfully...")</script>';
   echo '<script>window.location.href = "index_display_bill.php";</script>';
}
else
{
