...
<div class="s-right">
  ...
  <a href="about.php">About Us</a>
    ...
    <h1 style="margin-top: 10px;">Events In Ahmednagar</h1>
        

    <div class="container">
        <div class="card">
          <img src="../img/1" alt="" width="600" height="400">
          <img src="../img/2" alt="" width="600" height="400">
          <img src="../img/3" alt="" width="600" height="400">
          <img src="../img/4" alt="" width="600" height="400">
          <img src="../img/5" alt="" width="600" height="400">
    ...
    <div class="containers">
        <div class="card">
          <img src="../img/6" alt="" width="600" height="400">
          <img src="../img/7" alt="" width="600" height="400">
          <img src="../img/8" alt="" width="600" height="400">
          <img src="../img/9" alt="" width="600" height="400">
          <img src="../img/10" alt="" width="600" height="400">
