...
<div class="s-right">
  ...
  <a href="about.php">About Us</a>
    ...
    <h1 style="margin-top: 10px;">Premiere of the week</h1>
        

        <div class="container">
            <div class="card">
              <img src="../img/et1" alt="" width="600" height="400">
              <img src="../img/et2" alt="" width="600" height="400">
              <img src="../img/et3" alt="" width="600" height="400">
              <img src="../img/et4" alt="" width="600" height="400">
              <img src="../img/et5" alt="" width="600" height="400">
        
            </div>
            </div>
        </div>

        <h1 style="margin-top: 10px;">Free Movie For You</h1>
            
    
            <div class="container">
                <div class="card">
                  <img src="../img/et6" alt="" width="600" height="400">
                  <img src="../img/et7" alt="" width="600" height="400">
                  <img src="../img/et8" alt="" width="600" height="400">
                  <img src="../img/et9" alt="" width="600" height="400">
                  <img src="../img/et10"   alt="" width="600" height="400">
