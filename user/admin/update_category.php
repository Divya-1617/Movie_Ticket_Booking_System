...
$result = mysqli_query($con,"SELECT * FROM category WHERE category='$id'");
$data = mysqli_fetch_assoc($result);
?>
<form action="update_save_category.php" method="post" enctype="multipart/form-data">
    <input type="hidden" name="id" class="form-control" value="<?=$data['category']?>" >
