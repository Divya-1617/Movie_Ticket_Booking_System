...
<body>
    ...
    <div class="theater">
		...
		<form action="library_seat.php" method="post">
        <div class="row">
...
$qry="INSERT INTO `libseat`( `rid`,`seats`,`amount`,`a3`,`a4`) VALUES(NULL,'$seats','$amount','a3','a4')";
...
else
{
   ...
   echo '<script>window.location.href = "library_seat.php";</script>';
}
}
?>