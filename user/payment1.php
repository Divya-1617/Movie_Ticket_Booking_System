...
$qry="INSERT INTO `payment`( `rid`,`cno`,`name`,`expiry`,`expiry2`,`cvv`) VALUES(NULL,'$cno','$name','$expiry','$expiry2','$cvv')";
$run=mysqli_query($con,$qry);

if($run==true)
{
	echo '<script>alert("Pyment paid Successfully...")</script>';
   echo '<script>window.location.href = "display_bill.php";</script>';
}
else
{
