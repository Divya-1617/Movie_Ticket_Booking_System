...
<body>
    ...
    <div class="theater">
		...
		<form action="index_seat.php" method="post">
        <div class="row">
            ...
            <div class="seat"  name="a10" >A10</div>
		...
		<div class="row">
            ...
            <div class="seat occupied">F8</div>
            <div class="seat occupied">F9</div>
            <div class="seat">F10</div>
		    <div class="seat occupied">F11</div>
        ...
        seats.forEach(seat => {
            seat.addEventListener('click', () => {
                if (!seat.classList.contains('selected')) {
                    ...
                    selectedSeats++;
                    selectedAmount += 300; // Assuming each seat costs $10
                } else {
...
$qry="INSERT INTO `iseat`( `rid`,`seats`,`amount`,`a9`,`a10`) VALUES(NULL,'$seats','$amount','a9','a10')";
...
{
	echo '<script>alert("Seat Not Booked...")</script>';
   echo '<script>window.location.href = "index_seat.php";</script>';
}
}
?>